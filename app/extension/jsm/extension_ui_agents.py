...
def app_specific_action_notification_config_web_action_support(webdriver, datasets):
    ...
    def measure():
        ...
        def sub_measure():
            page.go_to_url(
                f"{JSM_SETTINGS.server_url}/secure/NotificationsConfigWebActionSupport.jspa")
...
#         def sub_measure():
#             page.go_to_url(
#                 f"{JSM_SETTINGS.server_url}/secure/MFJSDCNotificationSchemaWebAction.jspa?projectKey=SDP")
