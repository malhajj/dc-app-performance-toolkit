...
def test_1_selenium_custom_action_test1(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.test_1_selenium_custom_action_test1(jira_webdriver, jira_datasets)

def test_1_selenium_custom_action_test2(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.test_2_selenium_custom_action_test2(jira_webdriver, jira_datasets)
