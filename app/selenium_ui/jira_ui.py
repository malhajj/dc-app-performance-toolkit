...
def test_1_selenium_custom_action_mfj_test1(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.app_specific_action_mfj_test1(jira_webdriver, jira_datasets)

def test_1_selenium_custom_action_mfj_test2(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.app_specific_action_mfj_test2(jira_webdriver, jira_datasets)

def test_1_selenium_custom_action_mfj_test3(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.app_specific_action_mfj_test3(jira_webdriver, jira_datasets)
