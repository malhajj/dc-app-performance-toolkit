...
def test_1_selenium_custom_action_afj_test1(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.app_specific_action_afj_test1(jira_webdriver, jira_datasets)
