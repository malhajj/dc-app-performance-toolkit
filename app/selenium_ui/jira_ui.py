...
def test_1_selenium_custom_action_js_mobile_service_management_portal_branded_test1(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.app_specific_action_js_mobile_service_management_portal_branded_test1(jira_webdriver, jira_datasets)

def test_2_selenium_custom_action_js_mobile_service_management_portal_branded_test2(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.app_specific_action_js_mobile_service_management_portal_branded_test2(jira_webdriver, jira_datasets)
